...
<div class="banner">
    <h1 class="banner-head">
        MWO-Monitor is and will be free. <br>
		<br>
...
<input type="hidden" name="hosted_button_id" value="W2GRT9KS3GL88">
...
<div class="footer l-box">
    <p>
        Thank you for your support. You can reach me on reddit as <a href="http://reddit.com/u/w0nk0">w0nk0</a> or under "Captain Jameson" in-game.
    </p>
</div>
